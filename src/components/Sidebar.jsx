  ...
  return (
    ...
    >
      <div className="h-full relative">
        ...
        <div className="h-[50%]">
          <ul className="h-full flex flex-col justify-evenly  text-white text-center font-bold text-4xl">
            {navLinks.map((link) => (
              <li key={link.id}>
        ...
        <div className="flex flex-col justify-evenly h-[50%]">
          ...
          <button
            ...
            className="w-full h-[30%] bg-[#1976d2] flex justify-center items-center rounded-lg"
          >
            <img src={facebook} alt="facebook" className="w-[80px] mb-3" />
          </button>
        </div>
      </div>
    </Menu>
